...
abstract class AbstractDescriptor<T, J> implements Descriptor<T, J> {
   ...
   */
  public J marshallInline(T entity, boolean cyclic) {
    Preconditions.checkState(isInlineable());
    return marshall(entity, cyclic);
  }
   ...
   * verifying that the entity is inlineable.
   */
  public T unmarshallInline(J entity, boolean cyclic) {
    Preconditions.checkState(isInlineable());
    return unmarshall(entity, cyclic);
  }
